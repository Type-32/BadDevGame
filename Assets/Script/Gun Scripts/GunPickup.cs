...
public class GunPickup : MonoBehaviour
{
    ...
    Transform parent;
    void Start(){
        parent = FindObjectOfType<WeaponSwitching>().transform;
        holder = FindObjectOfType<WeaponSwitching>();
    }
    public void PickupGun(){
        GameObject cachedObj = Instantiate(mainGunObject, parent);
        holder.weaponList.Add(cachedObj);
        Debug.Log("Gun Picked From Pickup ");
        cachedObj.GetComponent<GunStats>().weaponFireType = stats.weaponFireType;
        ...
        cachedObj.GetComponent<GunStats>().availableFireModes = stats.availableFireModes;
