...
public class GunAnimation : MonoBehaviour
{
    ...
    private void CalculateSway()
    {
        ...
        mouseInputY = -Input.GetAxis("Mouse Y") - (gun.player.controls.MoveVec.y * 1.2f);
    }
    ...
    */
    ...
    {
        gunModel.transform.localPosition = new Vector3(Mathf.Lerp(gunModel.transform.localPosition.x, defaultXPos, Time.deltaTime * 2), Mathf.Lerp(gunModel.transform.localPosition.y, defaultYPos, Time.deltaTime * 2), gunModel.transform.localPosition.z + (-Input.GetAxis("Vertical") / 70));
